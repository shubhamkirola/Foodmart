...
const Cart = () => {
  ...
  return cartItems.length ? (
    ...
    <div className="max-w-screen-md h-full mt-0 mx-auto my-auto mb-14 p-4 flex justify-center content-center">
      <img
        className="mt-5"
        src="https://th.bing.com/th/id/R.afa6a28d0ee0b5e7d55b7a5aecdfedec?rik=eOl3Z%2bU0XvmYlw&riu=http%3a%2f%2fiticsystem.com%2fimg%2fempty-cart.png&ehk=0omil1zRH7T3Pb5iTzvueamUQLSSb55vgY7dLFF8Bl8%3d&risl=&pid=ImgRaw&r=0" alt="img"
      />
    </div>
  );
};
